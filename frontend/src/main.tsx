              ...
              <div className="update-card">
                ...
                <div className="update-version-grid">
                  ...
                  <div className="update-version-item">
                    ...
                    <small>
                      {updateInfo?.revision_short
                        ? `Revision ${updateInfo.revision_short}`
                        : 'Revision unbekannt'}
                    </small>
                  </div>
                  ...
                  <div className="update-version-item">
                    ...
                    <strong>
                      {updateInfo?.channel.name ||
                        'main'}
                    </strong>

                    <small>
                      {updateInfo?.channel.revision_short
                        ? `Revision ${updateInfo.channel.revision_short}`
                        : 'nicht erreichbar'}
                    </small>
                  </div>
                ...
                <div className="update-status-line">
                  ...
                  >
                    {updateInfo?.available
                      ? 'Update verfügbar'
                      : updateInfo?.relation === 'local_ahead'
                        ? 'Entwicklungsstand'
                        : 'Aktuell'}
                  </Tag>
                ...
                {updateInfo?.dirty && (
                  <div className="update-warning">
                    ...
                    Updates werden auf einem solchen Stand
                    später bewusst blockiert.
                  </div>
                )}
                ...
                {!updateInfo?.rootless_ready &&
                  ...
                  <div className="update-permissions">
                    ...
                    <div>
                      ...
                      <b>
                        {updateInfo.permissions.application
                          ? '✓'
                          : '–'}
                      </b>
                      ...
                      <b>
                        {updateInfo.permissions.update_data
                          ? '✓'
                          : '–'}
                      </b>
                      ...
                      <b>
                        {updateInfo.permissions.frontend
                          ? '✓'
                          : '–'}
                      </b>
                    </div>
                ...
                <div className="update-actions">
                  ...
                  <span>
                    Installation wird im nächsten
                    Schritt aktiviert – weiterhin
                    ohne Root-Rechte.
                  </span>
